...
- Inducted to [SportsAnalytics](https://CRAN.R-project.org/view=SportsAnalytics) CRAN Task View w/ 1400+ downloads & maintained `pkgdown` [website](https://rentosaijo.github.io/nhlscraper/)
